...
@section('title', 'Dashboard - Coordinador de Comunidades')
@section('header_title', 'COORDINACIÓN DE COMUNIDADES')
...
@section('content')
        ...
        <div class="card-body p-4 p-md-5 text-white">
            <div class="row align-items-center g-4">
                <div class="col-lg-8">
                    ...
                    <h3 class="fw-bold mb-3 text-white">¡Bienvenido, Coordinador de Comunidades!</h3>
                    <p class="mb-0 fs-6" style="color: rgba(255,255,255,0.88); max-width: 760px;">
                        Supervisa las comunidades, grupos, alumnos y catequistas asignados.
                        Consulta evaluaciones y reportes por comunidad.
                    </p>
                </div>
                <div class="col-lg-4 text-center d-none d-lg-block">
                    <i class="bi bi-buildings" style="font-size: 7rem; opacity: .22;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-3">
        <div>
            <h5 class="section-label mb-1">Indicadores de comunidades</h5>
            <small class="text-muted">Resumen del periodo activo y datos principales.</small>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card theme-primary shadow-sm p-2">
                <div class="card-body">
                    ...
                    <div class="stat-description">Comunidades registradas.</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card theme-info shadow-sm p-2">
                <div class="card-body">
                    ...
                    <div class="stat-description">Total de alumnos activos.</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card theme-warning shadow-sm p-2">
                <div class="card-body">
                    ...
                    <div class="stat-description">Asignaciones del periodo.</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card theme-secondary shadow-sm p-2">
                <div class="card-body">
                    ...
                    <div class="stat-label mt-2">Catequistas</div>
                    <div class="stat-description">Catequistas aprobados.</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card theme-success shadow-sm p-2">
                <div class="card-body">
                    ...
                    <div class="stat-description">Alumnos inscritos en el periodo.</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-4">
            <div class="card stat-card theme-purple shadow-sm p-2">
                <div class="card-body">
                    ...
                    <div class="stat-description">Evaluaciones registradas.</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-3 mt-4">
        <div>
            ...
            <small class="text-muted">Consulta información por comunidad.</small>
        </div>
    </div>

    <div class="row g-4">
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_comunidades.comunidades.index') }}" class="quick-link">
                <div class="card quick-card theme-primary shadow-sm p-2">
                    <div class="card-body">
                        <div class="icon-box"><i class="bi bi-geo-alt fs-3"></i></div>
                        <h6>Comunidades</h6>
                        <p class="text-muted mb-0">Ver comunidades registradas.</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_comunidades.alumnos_comunidad.index') }}" class="quick-link">
                <div class="card quick-card theme-info shadow-sm p-2">
                    <div class="card-body">
                        <div class="icon-box"><i class="bi bi-people fs-3"></i></div>
                        <h6>Alumnos por comunidad</h6>
                        <p class="text-muted mb-0">Alumnos inscritos y sus datos.</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_comunidades.grupos.index') }}" class="quick-link">
                <div class="card quick-card theme-warning shadow-sm p-2">
                    <div class="card-body">
                        <div class="icon-box"><i class="bi bi-diagram-3 fs-3"></i></div>
                        <h6>Grupos</h6>
                        <p class="text-muted mb-0">Grupos por comunidad.</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_comunidades.catequistas.index') }}" class="quick-link">
                <div class="card quick-card theme-secondary shadow-sm p-2">
                    <div class="card-body">
                        <div class="icon-box"><i class="bi bi-person-workspace fs-3"></i></div>
                        <h6>Catequistas</h6>
                        <p class="text-muted mb-0">Listado de catequistas asignados.</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_comunidades.evaluaciones.index') }}" class="quick-link">
                <div class="card quick-card theme-success shadow-sm p-2">
                    <div class="card-body">
                        <div class="icon-box"><i class="bi bi-clipboard-check fs-3"></i></div>
                        <h6>Evaluaciones</h6>
                        <p class="text-muted mb-0">Consulta de calificaciones.</p>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_comunidades.boletas.index') }}" class="quick-link">
                <div class="card quick-card theme-purple shadow-sm p-2">
                    <div class="card-body">
                        <div class="icon-box"><i class="bi bi-printer fs-3"></i></div>
                        <h6>Boletas</h6>
                        <p class="text-muted mb-0">Generación y consulta de boletas.</p>
                    </div>
                </div>
            </a>
        </div>
