...
@section('content')
    ...
    @else
        ...
        <div class="filter-card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('coordinador_comunidades.evaluaciones.index') }}" id="filterForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a href="{{ route('coordinador_comunidades.evaluaciones.index') }}" class="btn btn-outline-secondary">
