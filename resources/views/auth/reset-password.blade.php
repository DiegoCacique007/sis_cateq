...
<head>
    ...
    <title>Establecer Nueva Contraseña | Parroquia La Asunción de María</title>
...
<div class="stage" id="stage">
    <div class="card-horizontal" id="tilt-card">
        ...
        <div class="brand-panel">
            ...
            <p class="system-desc">Sistema Integral de Gestión Parroquial. Actualice su información de acceso.</p>
        </div>
        ...
        <div class="form-panel">
            ...
            <div class="anim-item delay-1">
                ...
                <p class="form-subtitle">Ingresa tu nueva contraseña para restaurar el acceso a tu cuenta.</p>
            </div>
