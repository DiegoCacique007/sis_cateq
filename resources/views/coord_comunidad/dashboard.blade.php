...
@section('content')
    ...
    <script>
        ...
        function inicializarMapa() {
            // Coordenadas de Valle de Bravo (¡Actualizado para ti!)
        ...
        async function cargarComunidades() {
            ...
            tbody.innerHTML = '<tr><td colspan="3" class="text-center py-4 text-muted"><div class="spinner-border spinner-border-sm text-primary me-2"></div>Cargando...</td></tr>';
            ...
            try {
                ...
                tbody.innerHTML = '<tr><td colspan="3" class="text-center py-3 text-danger">Error al cargar comunidades.</td></tr>';
            }
        }
        ...
        function renderizarTabla() {
            ...
            if (filteredData.length === 0) {
                tbody.innerHTML = `<tr><td colspan="3" class="text-center py-4 text-muted"><i class="bi bi-inbox fs-3 d-block mb-1"></i>Vacio.</td></tr>`;
        ...
        async function guardarComunidad(e) {
            ...
            try {
                ...
                if(response.ok) {
                    resetForm();
                    cargarComunidades(); // Recarga y aplica paginación
                    if(marcadorTemp) map.removeLayer(marcadorTemp);
                } else {
