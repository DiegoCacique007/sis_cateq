...
@section('header_title', 'COORDINACIÓN GENERAL')
...
@section('content')
    <style>
        ...
        .theme-danger { border-left-color: #dc2626; }
        .theme-danger .icon-box { background: linear-gradient(135deg, #f87171, #dc2626); }
        .theme-danger h6 { color: #dc2626; }
    </style>
        ...
        <div class="card-body p-4 p-md-5 text-white">
            <div class="row align-items-center g-4">
                <div class="col-lg-8">
                    ...
                    <h3 class="fw-bold mb-3 text-white">¡Bienvenido, Coordinador General!</h3>
                    <p class="mb-0 fs-6" style="color: rgba(255,255,255,0.88); max-width: 760px;">
                        Supervisa y coordina toda la operación académica y pastoral de la catequesis:
                        alumnos, tutores, inscripciones, grupos, niveles, evaluaciones y reportes.
                    </p>
                </div>
                <div class="col-lg-4 text-center d-none d-lg-block">
                    <i class="bi bi-mortarboard" style="font-size: 7rem; opacity: .22;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card theme-purple shadow-sm p-2">
                <div class="card-body">
                    <div class="icon-box"><i class="bi bi-layers fs-3"></i></div>
                    <div class="stat-number">{{ $totalNiveles }}</div>
                    <div class="stat-label mt-2">Niveles</div>
                    <div class="stat-description">Niveles de catequesis.</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card theme-danger shadow-sm p-2">
                <div class="card-body">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card stat-card theme-info shadow-sm p-2">
                <div class="card-body">
                    <div class="icon-box"><i class="bi bi-person-hearts fs-3"></i></div>
                    <div class="stat-number">{{ $totalTutores }}</div>
                    <div class="stat-label mt-2">Tutores</div>
                    <div class="stat-description">Tutores registrados.</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-3 mt-4">
        <div>
            ...
            <small class="text-muted">Consulta información de cada módulo.</small>
        </div>
    </div>

    <div class="row g-4">
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_general.comunidades.index') }}" class="quick-link">
        ...
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_general.alumnos.index') }}" class="quick-link">
        ...
        <div class="col-md-6 col-xl-4">
            <a href="{{ route('coordinador_general.evaluaciones.index') }}" class="quick-link">
