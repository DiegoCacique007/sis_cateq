...
<head>
    ...
    <style>
        ...
        * {
        ...
        .nav-parroquia .nav-link.active-menu i,
    ...
    <aside class="sidebar">
        <div class="brand">
            ...
            <div>
                ...
                <p class="brand-sub mb-0">@yield('subtitle', 'Sistema de Catequesis')</p>
            </div>
        </div>
                ...
                @if(auth()->user()->role === 'secretaria')
                    ...
                    @php
                        ...
                        $catalogosActivos =
                            ...
                            request()->routeIs('secretaria.niveles.*') ||
                            request()->routeIs('secretaria.grupos.*') ||
                            request()->routeIs('secretaria.periodos.*') ||
                            request()->routeIs('secretaria.unidades.*') ||
                    ...
                    <a class="nav-link {{ request()->routeIs('secretaria.usuarios.pendientes') ? 'active' : '' }}"
                       href="{{ route('secretaria.usuarios.pendientes') }}">
                        <i class="bi bi-person-lines-fill"></i>
                        <span>Usuarios pendientes</span>
                    </a>

                    <button class="menu-toggle {{ $gestionEscolarActiva ? 'active' : '' }}"
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#menuGestionEscolar"
                            aria-expanded="{{ $gestionEscolarActiva ? 'true' : 'false' }}"
                            aria-controls="menuGestionEscolar">
                        <i class="bi bi-mortarboard"></i>
                        <span>Gestión Escolar</span>
                        <i class="bi bi-chevron-down chevron"></i>
                    </button>

                    <div class="collapse {{ $gestionEscolarActiva ? 'show' : '' }}" id="menuGestionEscolar">
                        <div class="submenu">
                            <a class="nav-link {{ request()->routeIs('secretaria.alumnos.*') ? 'active' : '' }}" href="{{ route('secretaria.alumnos.index') }}">
                                <i class="bi bi-people"></i><span>Alumnos</span>
                            </a>

                            <a class="nav-link {{ request()->routeIs('secretaria.tutores.*') ? 'active' : '' }}" href="{{ route('secretaria.tutores.index') }}">
                                <i class="bi bi-person-badge"></i><span>Tutores</span>
                            </a>

                            <a class="nav-link {{ request()->routeIs('secretaria.inscripciones.*') ? 'active' : '' }}" href="{{ route('secretaria.inscripciones.index') }}">
                    ...
                    <button class="menu-toggle {{ $catalogosActivos ? 'active' : '' }}"
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#menuCatalogos"
                            aria-expanded="{{ $catalogosActivos ? 'true' : 'false' }}"
                    ...
                    <div class="collapse {{ $catalogosActivos ? 'show' : '' }}" id="menuCatalogos">
                        <div class="submenu">
                            <a class="nav-link {{ request()->routeIs('secretaria.comunidades.*') ? 'active' : '' }}" href="{{ route('secretaria.comunidades.index') }}">
                                <i class="bi bi-geo-alt"></i><span>Comunidades</span>
                            </a>

                            <a class="nav-link {{ request()->routeIs('secretaria.niveles.*') ? 'active' : '' }}" href="{{ route('secretaria.niveles.index') }}">
                                <i class="bi bi-layers"></i><span>Niveles</span>
                            </a>

                            <a class="nav-link {{ request()->routeIs('secretaria.grupos.*') ? 'active' : '' }}" href="{{ route('secretaria.grupos.index') }}">
                                <i class="bi bi-collection"></i><span>Grupos</span>
                            </a>

                            <a class="nav-link {{ request()->routeIs('secretaria.periodos.*') ? 'active' : '' }}" href="{{ route('secretaria.periodos.index') }}">
                                <i class="bi bi-calendar-range"></i><span>Periodos</span>
                            </a>

                            <a class="nav-link {{ request()->routeIs('secretaria.unidades.*') ? 'active' : '' }}" href="{{ route('secretaria.unidades.index') }}">
                                <i class="bi bi-book"></i><span>Unidades</span>
                            </a>

                            <a class="nav-link {{ request()->routeIs('secretaria.rubros.*') ? 'active' : '' }}" href="{{ route('secretaria.rubros.index') }}">
                                <i class="bi bi-ui-checks-grid"></i><span>Rubros</span>
                            </a>
                        </div>
                    </div>
