...
<head>
    ...
    <title>@yield('title', 'SIS_CATEQ - Coordinador de Comunidades')</title>
    ...
    <aside class="sidebar">
        <div class="brand">
            ...
            <div>
                ...
                <p class="brand-sub mb-0">@yield('subtitle', 'Coord. Comunidades')</p>
            </div>
        </div>

        <nav class="nav flex-column nav-parroquia">
            @auth
                @if(auth()->user()->role === 'coordinador_comunidades')

                    <a class="nav-link {{ request()->routeIs('coordinador_comunidades.dashboard') ? 'active' : '' }}"
                       href="{{ route('coordinador_comunidades.dashboard') }}">
                        <i class="bi bi-house"></i><span>Inicio</span>
                    </a>

                    <a class="nav-link {{ request()->routeIs('coordinador_comunidades.comunidades.*') ? 'active' : '' }}"
                       href="{{ route('coordinador_comunidades.comunidades.index') }}">
                        <i class="bi bi-geo-alt"></i><span>Comunidades</span>
                    </a>

                    <a class="nav-link {{ request()->routeIs('coordinador_comunidades.alumnos_comunidad.*') ? 'active' : '' }}"
                       href="{{ route('coordinador_comunidades.alumnos_comunidad.index') }}">
                        <i class="bi bi-people"></i><span>Alumnos por comunidad</span>
                    </a>

                    <a class="nav-link {{ request()->routeIs('coordinador_comunidades.grupos.*') ? 'active' : '' }}"
                       href="{{ route('coordinador_comunidades.grupos.index') }}">
                        <i class="bi bi-diagram-3"></i><span>Grupos</span>
                    </a>

                    <a class="nav-link {{ request()->routeIs('coordinador_comunidades.catequistas.*') ? 'active' : '' }}"
                       href="{{ route('coordinador_comunidades.catequistas.index') }}">
                        <i class="bi bi-person-workspace"></i><span>Catequistas</span>
                    </a>

                    <a class="nav-link {{ request()->routeIs('coordinador_comunidades.evaluaciones.*') ? 'active' : '' }}"
                       href="{{ route('coordinador_comunidades.evaluaciones.index') }}">
                        <i class="bi bi-clipboard-check"></i><span>Evaluaciones</span>
                    </a>

                    <a class="nav-link {{ request()->routeIs('coordinador_comunidades.boletas.*') ? 'active' : '' }}"
                       href="{{ route('coordinador_comunidades.boletas.index') }}">
