...
@section('content')
    <style>
        ...
        .grupo-card .card-header-content {
            margin-bottom: 1rem;
            padding-right: 4.5rem;
        }

        .grupo-card .group-name {
            color: #1e3a8a;
            font-weight: 700;
            font-size: 1.08rem;
        ...
        .grupo-card .group-badge {
            background-color: #eef2ff;
            color: #2563eb;
            border: 1px solid #3b82f6;
        }

        .grupo-card .card-actions {
            position: absolute;
            top: 1.25rem;
            right: 1.25rem;
            display: flex;
        ...
        .grupo-card .btn-edit:hover {
            background-color: #3b82f6;
            color: #ffffff;
        }

        .grupo-card .btn-delete {
            border: 1px solid #ef4444;
            color: #ef4444;
        }

        .grupo-card .btn-delete:hover {
    ...
    <div class="card card-parroquia module-card border-0 shadow-sm">
        ...
        <div class="card-body border-bottom module-filter-bar">
            <form method="GET" action="{{ route(($route_prefix ?? 'secretaria.') . 'grupos.index') }}" class="row g-2 align-items-center">
                <div class="col-md-8">
                    <input
                        type="text"
                        name="search"
            ...
            @forelse($registros as $registro)
                <div class="grupo-card">
                    ...
                    <div class="card-actions">
                        ...
                        <form
                            action="{{ route('secretaria.grupos.destroy', $registro->id) }}"
                            method="POST"
                    ...
                    <div class="card-header-content">
                        ...
                        <span class="group-subtitle">Grupo disponible</span>
                    </div>
