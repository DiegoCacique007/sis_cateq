...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Estilo formal institucional para los nombres y texto general */
        .printed-name {
            font-family: 'Lato', Arial, sans-serif;
            font-size: 9pt;
            font-weight: 900;
        ...
        /* Estilo formal limpio y academico para las calificaciones */
        .formal-grade {
        ...
        /* Titulo ajustado para que entre en una sola fila */
        ...
        /* Tabla de calificaciones con bordes blancos sutiles */
        .cal-table {
            width: 100%;
        ...
        .cal-table th {
            font-family: 'Lato', Arial, sans-serif;
            border: 1px solid rgba(255, 255, 255, 0.4); /* Borde blanco casi invisible */
            text-align: center;
        ...
        .bg-orange { background-color: #B98535 !important; color: #111827 !important; }
        .bg-light-orange { background-color: #D4A351 !important; color: #111827 !important; }
        
        .bg-dark-beige { background-color: #DAB982 !important; }
        .bg-light-beige { background-color: #EFE2C6 !important; }
...
<body>
    ...
    <div class="meta-row">
        ...
        <div class="meta-promedio">
            PROMEDIO FINAL
            <div class="prom-box formal-grade" style="font-size: 13pt !important;">{{ $promedioFinal ?? '' }}</div>
        </div>
    </div>
        ...
        <tbody>
            @for($i = 0; $i < $totalUnidades; $i++)
                ...
                <tr class="{{ $rowClass }}">
                    ...
                    <td class="formal-grade">
                        @if($promUnidad !== null) {{ $promUnidad }} @endif
                    </td>
                    <td></td>
                </tr>
            @endfor
